...
const Login = () => {
  const kid = useSelector((state) => state.kidsReducer)
  console.log("inside of login component", kid)
  const [show, setShow] = React.useState(false)
  const handleClick = () => setShow(!show)
  //call function getKidsById on form submission
return (
