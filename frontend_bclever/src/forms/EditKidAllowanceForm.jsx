...
import { editKidAllowance } from '../redux/action/allowanceAction'
import cmlogo from '../images/cmlogo.jpg'
// import Errors from '../errors/Errors'

const EditKidAllowanceForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // debugger
    dispatch(editKidAllowance( id, editedAllowance, navigate))
  }
...
export default EditKidAllowanceForm