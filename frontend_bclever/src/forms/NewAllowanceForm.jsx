    ...
    <div className="w-full max-w-md space-y-8 grid grid-cols-2">
      ...
      <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
        ...
        <div className="-space-y-px rounded-md shadow-sm">
          <div>
            <label htmlFor="Name" className="sr-only">{currentParent.kids[0].name}</label>
            <input id="kid-name" name="kid-name" type="text" autoComplete="kid-name" required className="text-center relative block w-full rounded-t-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Balance" defaultValue={currentParent.kids[0].name}/>
          </div>    
          <div>
