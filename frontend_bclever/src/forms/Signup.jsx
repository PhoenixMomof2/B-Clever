...
const Signup = () => {
  ...
  function handleSubmit(e) {
    e.preventDefault()
    const kid = {
      name, age, grade, avatar, password, passwordConfirmation, wallet
    }
    ...
    <div className="w-full max-w-md space-y-8">
      ...
      <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
        ...
        <div className="-space-y-px rounded-md shadow-sm">
          ...
          <div>
            <label htmlFor="Wallet" className="sr-only">Wallet</label>
            <input id="wallet" name="wallet" type="text" autoComplete="wallet" required className="relative block w-full rounded-t-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Wallet" value={wallet} onChange={(e) => setWallet(e.target.value)}/>
          </div>
          <div>
