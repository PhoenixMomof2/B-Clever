...
const KidsCard = ({kid}) => {   
    ...
    return (
      <div className="bg-white overflow-hidden shadow-xl rounded-2xl ">       
        ...
        <div className="p-6">
          <h1 className="font-bold text-blue-500 text-3xl border-b">{kid.name}</h1>
          ...
          </svg>Grade - {kid.grade}</span>
          <Stars />
          <h2 className="py-2 text-lg font-semibold">I have <span className="text-green-400">${kid.wallet_total}</span> in my wallet!</h2>
        </div>   
